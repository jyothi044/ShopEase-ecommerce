      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h3 className="text-lg font-bold text-gray-900 mb-2">ShopEase</h3>
            <p className="text-gray-600 max-w-xs">
              Quality products delivered to your doorstep with a seamless shopping experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">All Products</a></li>
                <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">Featured</a></li>
                <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">New Arrivals</a></li>
              </ul>
            </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} ShopEase. All rights reserved.</p>
